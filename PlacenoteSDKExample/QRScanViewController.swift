...
protocol QRScannerPermissionViewControllerDelegate: class {
    func dismissPermissionView(_ qrScannerPermissionViewController: QRScanViewController)
    func cameraPermissionGranted(_ qrScannerPermissionViewController: QRScanViewController)
}
...
//    }
    ...
    @IBAction func scanAgain(_ sender: UIButton) {
        ...
        weak var addVC = self.storyboard?.instantiateViewController(withIdentifier: "showPlaceVC") as? ViewController
        addVC?.placeIDDD = detectedString ?? ""
